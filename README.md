...
Stefan Wyder & Heidi Tschanz-Lischer & Carla Bello
...
[Etherpad](https://public.etherpad-mozilla.org/p/BIO609_2018)
...
- Download the VM image (~3.5 GB) from dropfiles.uzh. Use the download link you got by email. Note that it is a large download, use an Ethernet connection if possible.
